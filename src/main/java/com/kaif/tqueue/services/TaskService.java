...
//        }
        ...
        try {
            ...
            if (taskFound) {
                // work was found — go again almost immediately, no artificial delay
                taskScheduler.schedule(this::processOneTask, Instant.now().plusMillis(10));
            } else {
                long jitter = ThreadLocalRandom.current().nextLong(0, 3000);
                long nextDelayMs = 2000 + jitter;
